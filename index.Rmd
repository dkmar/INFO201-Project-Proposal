...
<span style="color:red">**Seattle Police Department Police Report Incident**</span>, retrieved from `r link_markdown_Seattlegov`, is the dataset our group chose to work with. This dataset contains details about criminal incidents occurred within Seattle, and was recorded by responding officers's initial police reports. The information was transmitted to data.seattle.gov after the incidents were filed into the system. The data we extracted for our group project consists *at least 1,000,000 rows from 1997 to 2018*.
...
* Has the safety around UW campus declined or inclined?<br><br>
...
* <span style="color:red">**Grouping**</span> the data by year, location, incident types, time and other categories to summarize some essential information we would like to use.   
* <span style="color:red">**Reformating**</span> the overall dataset 
    ...
    + Mutating columns to convert dates to a different representation in order to analyze the data in a more convinent way.<br><br> 
